...
var require_search_insights_browser_cjs_min = __commonJS({
  "../node_modules/search-insights/dist/search-insights-browser.cjs.min.js"(exports) {
    ...
    function makeSendEvents(s) {
      return function(e, t) {
        ...
        if (!this._userHasOptedOut) {
          if (!(!isUndefined(this._apiKey) && !isUndefined(this._appId) || (null == (n = null == t ? void 0 : t.headers) ? void 0 : n["X-Algolia-Application-Id"]) && (null == (n = null == t ? void 0 : t.headers) ? void 0 : n["X-Algolia-API-Key"])))
    ...
    function sendRequest(e, t, n, i, s, r, o) {
      var a = (o = void 0 === o ? {} : o)["X-Algolia-Application-Id"], c = o["X-Algolia-API-Key"], o = __rest(o, ["X-Algolia-Application-Id", "X-Algolia-API-Key"]), d = Object.assign({ "X-Algolia-Application-Id": null != a ? a : s, "X-Algolia-API-Key": null != c ? c : r, "X-Algolia-Agent": encodeURIComponent(t.join("; ")) }, o);
      return e(n + "/1/events?" + Object.keys(d).map(function(e2) {
        return e2 + "=" + d[e2];
      }).join("&"), { events: i });
    }
    function createUUID() {
    ...
    function addedToCartObjectIDsAfterSearch() {
      for (var e = [], t = arguments.length; t--; )
        e[t] = arguments[t];
      var n = extractAdditionalParams(e), i = n.events, n = n.additionalParams;
      return this.sendEvents(addEventTypeAndSubtype("conversion", "addToCart", i), n);
    }
    ...
    function init(e) {
      var t;
      if (!isUndefined((e = void 0 === e ? {} : e).region) && -1 === SUPPORTED_REGIONS.indexOf(e.region))
    ...
    function setOptions(e, t, n) {
      var i = t.partial, s = __rest(t, ["partial"]);
      i || Object.assign(e, n), Object.assign(e, Object.keys(s).reduce(function(e2, t2) {
        return Object.assign(Object.assign({}, e2), ((e2 = {})["_" + t2] = s[t2], e2));
      }, {}));
    }
    ...
    var AlgoliaAnalytics = function(e) {
      e = e.requestFn;
      this._endpointOrigin = "https://insights.algolia.io", this._anonymousUserToken = true, this._userHasOptedOut = false, this._useCookie = false, this._cookieDuration = 6 * MONTH, this._ua = [], this.version = version, this.sendEvents = makeSendEvents(e).bind(this), this.init = init.bind(this), this.addAlgoliaAgent = addAlgoliaAgent.bind(this), this.setUserToken = setUserToken.bind(this), this.setAnonymousUserToken = setAnonymousUserToken.bind(this), this.getUserToken = getUserToken.bind(this), this.onUserTokenChange = onUserTokenChange.bind(this), this.setAuthenticatedUserToken = setAuthenticatedUserToken.bind(this), this.getAuthenticatedUserToken = getAuthenticatedUserToken.bind(this), this.onAuthenticatedUserTokenChange = onAuthenticatedUserTokenChange.bind(this), this.clickedObjectIDsAfterSearch = clickedObjectIDsAfterSearch.bind(this), this.clickedObjectIDs = clickedObjectIDs.bind(this), this.clickedFilters = clickedFilters.bind(this), this.convertedObjectIDsAfterSearch = convertedObjectIDsAfterSearch.bind(this), this.purchasedObjectIDsAfterSearch = purchasedObjectIDsAfterSearch.bind(this), this.addedToCartObjectIDsAfterSearch = addedToCartObjectIDsAfterSearch.bind(this), this.convertedObjectIDs = convertedObjectIDs.bind(this), this.addedToCartObjectIDs = addedToCartObjectIDs.bind(this), this.purchasedObjectIDs = purchasedObjectIDs.bind(this), this.convertedFilters = convertedFilters.bind(this), this.viewedObjectIDs = viewedObjectIDs.bind(this), this.viewedFilters = viewedFilters.bind(this), this.getVersion = getVersion.bind(this);
    };
    ...
    function processQueue(e) {
      ...
      t && (n = getFunctionalInterface(this), (e = e[t]).queue = e.queue || [], (t = e.queue).forEach(function(e2) {
        var e2 = [].slice.call(e2), t2 = e2[0], e2 = e2.slice(1);
        n.apply(void 0, [t2].concat(e2));
      }), t.push = function(e2) {
        var e2 = [].slice.call(e2), t2 = e2[0], e2 = e2.slice(1);
        n.apply(void 0, [t2].concat(e2));
      });
    ...
    var requestWithXMLHttpRequest = function(s, r) {
      return new Promise(function(e, t) {
        var n = JSON.stringify(r), i = new XMLHttpRequest();
